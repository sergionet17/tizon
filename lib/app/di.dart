...
///
/// Register services as singletons using GetIt library.
/// This function is called once on app startup.
void setupDI() {
  // Services (singletons)
  getIt.registerLazySingleton<ConnectivityService>(() => ConnectivityService());
  getIt.registerLazySingleton<SyncService>(() => getIt<SyncService>());
  ...
  getIt.registerLazySingleton<EncuestasSyncHandler>(
      () => EncuestasSyncHandler());
...
class MediosSyncHandler {}

class EncuestasSyncHandler {}
